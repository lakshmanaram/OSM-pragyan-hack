...
public class FarmerActivity extends ActionBarActivity {
    ...
    FarmerList fl;
    String URL = "http://192.168.43.79:3000/api/deliveryboy/deliver";
    EditText et;
    @Override
    ...
    class FarmerDetailspost extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                js.put("consumerUsername",fl.farmerid);
                js.put("consumerPassword",et.getText().toString());
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (!aBoolean) {
                ...
                Intent i = new Intent(FarmerActivity.this,Orders.class);
                startActivity(i);
                finish();
            }
        }
